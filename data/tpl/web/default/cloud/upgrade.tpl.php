...
<div class="upgrade-content" id="js-cloud-upgrade" ng-controller="CloudUpgradeCtrl" ng-cloak>
	...
	<div ng-if="upgrade && upgrade.upgrade">	
		<div class="upgrade-detail hidden" >
			<div class="header">
				{{upgrade.family}}{{upgrade.version}}【{{upgrade.release}}】版
			</div>
			<div class="info">
	...
	<form action="" class="form we7-form hidden" ng-if="upgrade && upgrade.upgrade">
			...
			<div class="panel we7-panel">
				...
				<div class="panel-body we7-padding">
					<div class="form-group">
						...
						<div class="form-controls col-sm-7 text-center form-control-static">{{upgrade.files.length > 0 ? upgrade.files.length : 0}} 个</div>
					...
					<div class="form-group">
						...
						<div class="form-controls col-sm-7 text-center form-control-static">{{upgrade.database.length > 0 ? upgrade.database.length  + '项' : '暂无更新数据库'}} </div>
					...
					<div class="form-group">
						...
						<div class="form-controls col-sm-7 text-center form-control-static">{{upgrade.scripts.length > 0 ? upgrade.scripts.length : 0}} 项</div>
