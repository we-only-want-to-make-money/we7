...
<div class="account-list-add-step" id="js-wxapp-create" ng-controller="MainCtrl" ng-cloak>
	...
	<ul class="we7-step">
		...
		<li class="new" ng-class="createStep == 3 ? 'active': ''" ng-if="create_type == 2"><span class="content">2. 设计首页</span> </li>
...
require(['fileUploader','underscore'], function(uploader){
	...
	var wxappinfo = {'name' : '<?php  echo $wxapp_info['name'];?>'};
	if (isedit) {
		...
		wxappinfo.version = '<?php  echo $wxapp_version['version'];?>';
		wxappinfo.description = '<?php  echo $wxapp_version['description'];?>';
	}
	...
	angular.module('wxApp').value('config', {
		...
		'create_type' : "<?php  echo $create_type;?>",
		'isedit' : isedit,
