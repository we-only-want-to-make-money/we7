			...
			<td class="vertical-middle table-manage-td">
				...
				<div class="manage-option text-right" ng-if="list.manage_premission">
					<a ng-if="list.current_user_role == 'founder' || list.current_user_role == 'vice_founder' || list.current_user_role == 'owner'"
					   href="{{links.post}}&acid={{list.acid}}&uniacid={{list.uniacid}}&account_type={{list.type}}">基础信息</a>

					<a ng-if="list.current_user_role == 'founder' || list.current_user_role == 'vice_founder' || list.current_user_role == 'owner'"
					   href="{{links.post}}&do=sms&uniacid={{list.uniacid}}&acid={{list.acid}}&account_type={{list.type}}" ng-if="list.type_sign == 'account'">短信信息</a>
					...
					<a ng-if="list.current_user_role == 'founder' || list.current_user_role == 'vice_founder' || list.current_user_role == 'owner'"
					   href="{{links.post}}&do=operators&uniacid={{list.uniacid}}&acid={{list.acid}}&account_type={{list.type}}">应用操作员管理</a>
